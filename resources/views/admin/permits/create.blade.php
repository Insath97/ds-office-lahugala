        ...
        <div class="section-body">
            <div class="card card-primary">
                <div class="card-header">
                    <h4>Create New Permit</h4>
                </div>

                <div class="card-body">
                    <!-- AJAX Form -->
                    <form id="permitForm" action="{{ route('admin.permits.store') }}" method="POST">
                        @csrf
                                ...
                                <div class="d-flex justify-content-around bg-light rounded-lg p-3 border">
                                    <label class="custom-switch mb-0">
                                        <input type="checkbox" name="permit_holder_copy" value="1"
                                            class="custom-switch-input" {{ old('permit_holder_copy') ? 'checked' : '' }}>
                                    ...
                                    <label class="custom-switch mb-0">
                                        <input type="checkbox" name="office_holder_copy" value="1"
                                            class="custom-switch-input" {{ old('office_holder_copy') ? 'checked' : '' }}>
                                        <span class="custom-switch-indicator"></span>
                        ...
                        <div class="form-group">
                            ...
                            <div class="btn-group btn-group-toggle" data-toggle="buttons">
                                <label class="btn btn-primary {{ old('grant_issued', 0) == 0 ? 'active' : '' }}">
                                    <input type="radio" name="grant_issued" id="grant_issued_no" autocomplete="off"
                                        value="0" {{ old('grant_issued', 0) == 0 ? 'checked' : '' }}> No
                                </label>
                                <label class="btn btn-primary {{ old('grant_issued') == 1 ? 'active' : '' }}">
                                    <input type="radio" name="grant_issued" id="grant_issued_yes" autocomplete="off"
                                        value="1" {{ old('grant_issued') == 1 ? 'checked' : '' }}> Yes
                                </label>
                            </div>
                        ...
                        <div class="form-row" id="grant_container"
                            ...
                            <div class="form-group col-md-4">
                                ...
                                <input type="text" name="land_registry_no"
                                    ...
                                    placeholder="Land registry number" value="{{ old('land_registry_no') }}">
                    ...
                    error: function(response) {
                        ...
                        if (response.status === 422) {
                            ...
                            showToast('error', response.responseJSON.message ||
                                'An error occurred while creating the permit.');
                        } else {
