                        ...
                        <div class="form-group">
                            ...
                            <select name="service_type"
                                ...
                                @foreach ($main_service as $item)
                                    <option value="{{ $item->service_type_id }}">{{ $item->service_type->name }}</option>
                                @endforeach
                            </select>
                            @error('service_type')
                        ...
                        <div class="form-row">
                            ...
                            <div class="form-group col-md-4 mt-4 d-flex justify-content-start">
                                <label class="custom-switch mt-2">
                                    <input type="radio" name="r_time_type" value="minutes" class="custom-switch-input">
                                    <span class="custom-switch-indicator"></span>
                                    <span class="custom-switch-description">Minutes</span>
                                </label>
                                <label class="custom-switch mt-2 ml-3">
                                    <input type="radio" name="r_time_type" value="hours" class="custom-switch-input">
                                    <span class="custom-switch-indicator"></span>
                                    <span class="custom-switch-description">Hours</span>
                                </label>
                                <label class="custom-switch mt-2 ml-3">
                                    <input type="radio" name="r_time_type" value="days" class="custom-switch-input">
                                    <span class="custom-switch-indicator"></span>
