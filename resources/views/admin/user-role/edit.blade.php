    ...
    <div class="section">
        ...
        <div class="section-body">
            <div class="card card-primary">
                ...
                <div class="card-body">
                    <form action="{{ route('admin.user-role.update', $users->id) }}" method="POST">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="user_name" value="{{ $users->name }}"
                        ...
                        <div class="form-group">
                            ...
                            <input type="email" name="user_email" value="{{ $users->email }}"
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control select2 @error('role') is-invalid @enderror" name="role">
                                ...
                                @foreach ($roles as $role)
                                    <option {{ $role->name === $users->getRoleNames()->first() ? 'selected' : '' }}
